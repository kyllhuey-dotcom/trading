...
class MarketUniverse:
    ...
    def __init__(self):
        ...
        self.universe = {
            ...
            "ftse_mib": {"display_symbol": "FTSE MIB", "asset_class": "INDICES", "name": "FTSE MIB", "providers": {"yahoo_indices": "^FTSEMIB.MI"}, "broker_symbols": {"gate": "MIB40"}, "tick_size": 1.0, "lot_size": 1, "min_order": 1.0, "leverage_max": 20, "timezone": "Europe/Rome"},
            ...
            "googl": {"display_symbol": "GOOGL", "asset_class": "STOCKS", "name": "Alphabet Inc. (Google)", "providers": {"yahoo_stocks": "GOOGL"}, "broker_symbols": {"gate": "GOOGL"}, "tick_size": 0.01, "lot_size": 1, "min_order": 1.0, "leverage_max": 5, "timezone": "America/New_York"},
            "meta": {"display_symbol": "META", "asset_class": "STOCKS", "name": "Meta Platforms, Inc.", "providers": {"yahoo_stocks": "META"}, "broker_symbols": {"gate": "META"}, "tick_size": 0.01, "lot_size": 1, "min_order": 1.0, "leverage_max": 5, "timezone": "America/New_York"},
            ...
            "amd": {"display_symbol": "AMD", "asset_class": "STOCKS", "name": "Advanced Micro Devices, Inc.", "providers": {"yahoo_stocks": "AMD"}, "broker_symbols": {"gate": "AMD"}, "tick_size": 0.01, "lot_size": 1, "min_order": 1.0, "leverage_max": 5, "timezone": "America/New_York"},
            ...
            "mc_pa": {"display_symbol": "LVMH", "asset_class": "STOCKS", "name": "LVMH Moët Hennessy Louis Vuitton", "providers": {"yahoo_stocks": "MC.PA"}, "broker_symbols": {"gate": "MC"}, "tick_size": 0.1, "lot_size": 1, "min_order": 1.0, "leverage_max": 5, "timezone": "Europe/Paris"},
