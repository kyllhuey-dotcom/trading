...
async def micro_loop_capital():
    ...
    while True:
        ...
        except Exception as e: logger.error(f"Capital Loop Error: {e}")
...
async def micro_loop_management():
    ...
    while True:
        ...
        except Exception as e: logger.error(f"Management Loop Error: {e}")
...
async def micro_loop_broadcaster():
    ...
    while True:
        ...
        except Exception as e: logger.error(f"Broadcaster Loop Error: {e}")
        await asyncio.sleep(0.2)
